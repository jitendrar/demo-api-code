			            ...
			            <div class="row">
		                    <div class="col-md-6">
		                        <div class="form-group">
		                            ...
		                            <div class="col-md-9">
		                            	{!! Form::text('delivery_charge',$delivery_charge,['class'=>'form-control','placeholder'=>'Delivery Charge','readonly'=>'readonly']) !!}
		                            </div>
		                        </div>
		                    </div>
		                    <div class="col-md-6">
				            ...
				            <div class="row">
				            	<div class="col-md-6">
			                        <div class="form-group">
			                            ...
			                            <div class="col-md-9">
			                                 <div class="col-md-4">
												<input id="quantity-0" readonly="readonly" data-stockprice="stockprice-0" type="text" value="0" name="quantity[]" class="form-control QuantityForCount" style="width: 60px;" required="required" >
					                        </div>
